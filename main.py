...
fig2.tight_layout()
plt.savefig('avg_speed_scatter_plot.png', dpi=200)
plt.show()
...
plt.savefig('total_runs_pie_chart.png', dpi=200)
plt.show()
...
plt.savefig('total_distance_pie_chart.png', dpi=200)
plt.show()
...
fig5.tight_layout()
plt.savefig('avg_relative_effort_bar_chart.png', dpi=200)
plt.show()
...
fig6.tight_layout()
plt.savefig('avg_pace_scatter_plot.png', dpi=200)
plt.show()
...
fig7.tight_layout()
plt.savefig('avg_heartrate_bar_chart.png', dpi=200)
plt.show()
...
ax8.set_ylabel("Shoe")
fig8.tight_layout()
plt.savefig('avg_distance_scatter_plot.png', dpi=200)
plt.show()
